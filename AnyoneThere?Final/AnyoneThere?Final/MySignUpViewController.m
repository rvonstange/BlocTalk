...
- (void)viewDidLoad {
    ...
    [self.signUpView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Drawing.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.additionalField setFrame:CGRectMake(fieldFrame.origin.x + 5.0f,
                                                         ...
                                                         fieldFrame.size.height)];
    yOffset += fieldFrame.size.height;
    [self.signUpView.signUpButton setFrame:CGRectMake(35.0f, fieldFrame.origin.y + yOffset, 250.0f, fieldFrame.size.height)];
